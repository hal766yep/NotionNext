...
module.exports = {
  ...
  POSTS_SHARE_SERVICES: process.env.NEXT_PUBLIC_POST_SHARE_SERVICES || 'link,wechat,qq,weibo,email,github',
  ...
  POSTS_PER_PAGE: process.env.NEXT_PUBLIC_POST_PER_PAGE || 9,
